...
const kittyPrompts = {
  orangeKittyNames() {
    ...
    //since we only want orange cats, I used filter which returned an array of cat objects so then
    //I used map to return an array of only the cat names
  },
  ...
  sortByAge() {
    ...
    // Annotation:
    // Write your annotation here as a comment
    /* sort kitties by their age in descending order
    */
  },
...
const clubPrompts = {
  membersBelongingToClubs() {
    ...
    //   ...etc
    // }
    let memberAndClubs = clubs.reduce((acc, club) => {
